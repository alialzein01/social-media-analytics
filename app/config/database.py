...
class DatabaseConfig:
    ...
    def setup_indexes(self):
        ...
        posts.create_index([('text', 'text')])  # Text search index
        ...
        comments.create_index([('text', 'text')])  # Text search index
